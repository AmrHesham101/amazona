...
export default function SkeletonLoader() {
  return (
    <div
      role="status"
      className="card border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700"
    >
      ...
      <div className="center-content">
        <div className="h-3.5 bg-gray-200 rounded-full dark:bg-gray-700 w-48 mb-4 mt-5"></div>
